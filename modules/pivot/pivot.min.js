  ...
  callWithJQuery(function ($) {
          ...
          return function (data, rowKey, colKey) {
            return {
              ...
              value: function () {
                ...
                sign = upper ? 1 : -1;
                return (
                  (0.821187207574908 / this.sumDenom +
                    this.sumNum / this.sumDenom +
                    1.2815515655446004 *
                      sign *
                      Math.sqrt(
    ...
    aggregators = (function (tpl) {
      return {
        ...
        Sum: tpl.sum(usFmt),
        "Double Sum": tpl.doublesum(usFmt),
    ...
    pivotTableRenderer = function (pivotData, opts) {
      ...
      result2.className = "valueWrapper";
    ...
    $.fn.pivotUI = function (input, inputOpts, overwrite, locale) {
      var a,
        ...
        uiTable,
        unused,
        unusedAttrsVerticalAutoCutoff,
        unusedAttrsVerticalAutoOverride,
        x;
      if (overwrite == null) {
        overwrite = false;
      }
      ...
      try {
        ...
        fn1 = function (attr) {
          ...
          if (values.length > opts.menuLimit) {
            ...
            for (n = 0, len2 = ref1.length; n < len2; n++) {
              ...
              $("<input>")
                .attr("type", "checkbox")
                .addClass("pvtFilter")
                .attr("checked", !filterItemExcluded)
          ...
          $("<button>", {
            ...
            .text(opts.localeStrings.cancel)
            .appendTo(finalButtons)
            .bind("click", function () {
        ...
        rowOrderArrow = $("<a>", {
          ...
          .data("order", opts.rowOrder)
          .html(ordering[opts.rowOrder].rowSymbol)
          .bind("click", function () {
        ...
        colOrderArrow = $("<a>", {
          ...
          .data("order", opts.colOrder)
          .html(ordering[opts.colOrder].colSymbol)
          .bind("click", function () {
            $(this).data("order", ordering[$(this).data("order")].next);
...
(function () {
  ...
  (e = function (e) {
    ...
    var r, t, o, i, n;
    return (
      (i = e.pivotUtilities.numberFormat),
      (n = e.pivotUtilities.aggregatorTemplates),
      (r = i({ thousandsSep: " ", decimalSep: "," })),
      (t = i({ digitsAfterDecimal: 0, thousandsSep: " ", decimalSep: "," })),
      (o = i({ digitsAfterDecimal: 1, scaler: 100, suffix: "%", thousandsSep: " ", decimalSep: "," })),
      (e.pivotUtilities.locales.fr = {
        localeStrings: {
        ...
        aggregators: {
          Nombre: n.count(t),
          "Nombre de valeurs uniques": n.countUnique(t),
          "Liste de valeurs uniques": n.listUnique(", "),
          Somme: n.sum(r),
          "Somme en entiers": n.sum(t),
          Moyenne: n.average(r),
          Minimum: n.min(r),
          Maximum: n.max(r),
          Premier: n.first(r),
          Dernier: n.last(r),
          "Ratio de sommes": n.sumOverSum(r),
          "Borne supérieure 80%": n.sumOverSumBound80(!0, r),
          "Borne inférieure 80%": n.sumOverSumBound80(!1, r),
          "Somme en proportion du totale": n.fractionOf(n.sum(), "total", o),
          "Somme en proportion de la ligne": n.fractionOf(n.sum(), "row", o),
          "Somme en proportion de la colonne": n.fractionOf(n.sum(), "col", o),
          "Nombre en proportion du totale": n.fractionOf(n.count(), "total", o),
          "Nombre en proportion de la ligne": n.fractionOf(n.count(), "row", o),
          "Nombre en proportion de la colonne": n.fractionOf(n.count(), "col", o),
        },
        renderers: {
          Table: e.pivotUtilities.renderers.Table,
          "Table avec barres": e.pivotUtilities.renderers["Table Barchart"],
          "Carte de chaleur": e.pivotUtilities.renderers.Heatmap,
          "Carte de chaleur par ligne": e.pivotUtilities.renderers["Row Heatmap"],
          "Carte de chaleur par colonne": e.pivotUtilities.renderers["Col Heatmap"],
        },
      })
    );
  });
...
(function () {
  ...
  (e = function (e) {
    ...
    var i, o, a, r, t;
    return (
      (r = e.pivotUtilities.numberFormat),
      (t = e.pivotUtilities.aggregatorTemplates),
      (i = r({ thousandsSep: " ", decimalSep: "," })),
      (o = r({ digitsAfterDecimal: 0, thousandsSep: " ", decimalSep: "," })),
      (a = r({ digitsAfterDecimal: 1, scaler: 100, suffix: "%", thousandsSep: " ", decimalSep: "," })),
      (e.pivotUtilities.locales.it = {
        localeStrings: {
        ...
        aggregators: {
          Numero: t.count(o),
          "Numero di valori unici": t.countUnique(o),
          "Elenco di valori unici": t.listUnique(", "),
          Somma: t.sum(i),
          "Somma intera": t.sum(o),
          Media: t.average(i),
          Minimo: t.min(i),
          Massimo: t.max(i),
          Rapporto: t.sumOverSum(i),
          "Limite superiore 80%": t.sumOverSumBound80(!0, i),
          "limite inferiore 80%": t.sumOverSumBound80(!1, i),
          "Somma proporzionale al totale": t.fractionOf(t.sum(), "total", a),
          "Somma proporzionale alla riga": t.fractionOf(t.sum(), "row", a),
          "Somma proporzionale alla colonna": t.fractionOf(t.sum(), "col", a),
          "Numero proporzionale al totale": t.fractionOf(t.count(), "total", a),
          "Numero proporzionale alla riga": t.fractionOf(t.count(), "row", a),
          "Numero proporzionale alla colonna": t.fractionOf(t.count(), "col", a),
        },
        renderers: {
          Tabella: e.pivotUtilities.renderers.Table,
          "Tabella con grafico": e.pivotUtilities.renderers["Table Barchart"],
          "Mappa di calore": e.pivotUtilities.renderers.Heatmap,
          "Mappa di calore per righe": e.pivotUtilities.renderers["Row Heatmap"],
          "Mappa di calore per colonne": e.pivotUtilities.renderers["Col Heatmap"],
        },
      })
    );
  });
